...
class SymbolTable:
    ...
    def add_program_name(self, name: str):
        ...
        self.tab.append(new_entry)
        # PENTING: Jangan update current_block["last"]
    ...
    def add_builtin_procedure(self, name: str):
        ...
        # Builtins should always be added to global scope (level 0)
        global_block = self.btab[0]

        # Builtins don't link to other entries
        link_idx = 0
        ...
        new_entry = {
            ...
            "type": TypeKind.NOTYPE,
            "ref": 0,  # Predefined, no block reference
            "nrm": 1,
            "lev": 0,  # Global level
            "adr": 0
        }
    ...
    def print_tables(self):
        ...
        for i, entry in enumerate(self.tab):
            # Comment kalo mo show reserved words
